                ...
                glfw::WindowEvent::CursorPos(x, y) => {
                    ...
                    match self.last_cursor_position {
                        Some((px, py)) => raw.push(RawInput::new(time, DeviceType::Mouse, 0,
                            RawInputEvent::Move((x-px)/self.current_size.0,
...
fn map_keycode(keycode: glfw::Key) -> input::types::KeyCode {
    match keycode {
        ...
        glfw::Key::Num0 => input::types::KeyCode::Numpad0,
        glfw::Key::Num1 => input::types::KeyCode::Numpad1,
        glfw::Key::Num2 => input::types::KeyCode::Numpad2,
        glfw::Key::Num3 => input::types::KeyCode::Numpad3,
        glfw::Key::Num4 => input::types::KeyCode::Numpad4,
        glfw::Key::Num5 => input::types::KeyCode::Numpad5,
        glfw::Key::Num6 => input::types::KeyCode::Numpad6,
        glfw::Key::Num7 => input::types::KeyCode::Numpad7,
        glfw::Key::Num8 => input::types::KeyCode::Numpad8,
        glfw::Key::Num9 => input::types::KeyCode::Numpad9,
        ...
        glfw::Key::Kp0 => input::types::KeyCode::Key0,
        glfw::Key::Kp1 => input::types::KeyCode::Key1,
        glfw::Key::Kp2 => input::types::KeyCode::Key2,
        glfw::Key::Kp3 => input::types::KeyCode::Key3,
        glfw::Key::Kp4 => input::types::KeyCode::Key4,
        glfw::Key::Kp5 => input::types::KeyCode::Key5,
        glfw::Key::Kp6 => input::types::KeyCode::Key6,
        glfw::Key::Kp7 => input::types::KeyCode::Key7,
        glfw::Key::Kp8 => input::types::KeyCode::Key8,
        glfw::Key::Kp9 => input::types::KeyCode::Key9,
